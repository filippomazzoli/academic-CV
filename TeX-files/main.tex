...
\usepackage[a4paper, left=3.5cm, right=2.5cm, top=2.5cm, bottom=2.5cm]{geometry}		% width=5.3in, height=10in, top margin=2cm on each page
...
{\begin{enumerate}[leftmargin=*,itemsep=0.1em]\setcounter{enumi}{\value{publicationCounter}}}
